            ...
            <div className="form-control w-full max-w-xs">
                ...
                <div className="form-control">
                    <label className="label cursor-pointer">
                        ...
                        <input type="radio" value='fair' name="radio-10" className="radio checked:bg-red-500" checked />
                    </label>
                    </div>
                    <div className="form-control">
                    <label className="label cursor-pointer">
                        <span className="label-text">Good</span> 
                        <input type="radio" value='good' name="radio-10" className="radio checked:bg-blue-500" checked />
                    </label>
                </div>
                    <div className="form-control">
                    <label className="label cursor-pointer">
                        <span className="label-text">Excellent</span> 
                        <input type="radio" value='excellent' name="radio-10" className="radio checked:bg-green-500" checked />
                    </label>
                </div>
            </div>
            </form>
