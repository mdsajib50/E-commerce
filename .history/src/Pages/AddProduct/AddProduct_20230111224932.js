...
const AddProduct = () => {
    return (
        <div className='bg-teal-200'>
           <div className='flex mx-auto text-center justify-center w-1/2'>
                <form>
                    <div className="form-control">
                        <label className="label">
                            <span className="label-text">Product Name</span>
                        </label>
                        <input type="text" name='product_name' placeholder="Type here" className="input input-bordered w-1/2" />
                    </div>
                    ...
                    <div className="form-control w-full max-w-xs rounded-xl">
                    <label className="label">
