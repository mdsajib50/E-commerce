...
const AddProduct = () => {
    const handelProduct = e =>{
        ...
        const product_name = form.product_name.val;
        const product_image =form.product_image;
        const category = form.category;
        const price = form.price;
        const original_price = form.original_price;
        const description = form.description;
        const location = form.location;
        const mobile_number = form.mobile;
        const purchase_date = form.date;
