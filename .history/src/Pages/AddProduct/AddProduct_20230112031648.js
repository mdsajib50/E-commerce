...
const AddProduct = () => {
    ...
    const handelProduct = e =>{
        ...
        const condition[field] = form.condition.value;
                    ...
                    <label className="label">
                        ...
                        <div className="form-control">
                            <label className="label cursor-pointer">
                                ...
                                <input onChange={handelOnChange} type="radio" value='fair' name="condition" className="radio checked:bg-red-500" defaultChecked />
                            </label>
                            </div>
                            <div className="form-control">
                            <label className="label cursor-pointer">
                                <span className="label-text text-xl">Good</span> 
                                <input onChange={handelOnChange} type="radio" value='good' name="condition" className="radio checked:bg-blue-500" defaultChecked />
                            </label>
                        </div>
                            <div className="form-control">
                            <label className="label cursor-pointer">
                                <span className="label-text text-xl">Excellent</span> 
                                <input onChange={handelOnChange} type="radio" value='excellent' name="condition" className="radio checked:bg-green-500" defaultChecked />
                            </label>
                        </div>
