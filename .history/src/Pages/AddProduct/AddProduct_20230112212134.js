           ...
           <div className=' text-center w-1/2 mx-auto shadow-2xl bg-slate-200 p-10 mt-5'>
                <form onSubmit={handelProduct}>
                    <div className="form-control">
                        ...
                        <input type="text" name='name' placeholder="Type here" defaultValue={user.buttondisplayNme} className="input input-bordered" readOnly />
                    </div>
                    <div className="form-control">
                        <label className="label">
                            <span className="label-text text-xl">Email</span>
                        </label>
                        <input type="email" name='email' placeholder="Type here" defaultValue={user.email} className="input input-bordered" readOnly />
                    </div>
                    <div className="form-control">
                        <label className="label">
