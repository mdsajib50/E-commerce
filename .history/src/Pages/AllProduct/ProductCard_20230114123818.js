    ...
    return (
        <div className="card card-compact bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <p className='text-lg font-semibold'><span className='text-fuchsia-500'>Short Description: </span>{details}</p>
                <p className='text-lg font-semibold'>Original Price: {price} tk</p>
                <p className='text-lg font-semibold'>Price: {resale_price} tk</p>
