...
const ProductCategory = ({setProduct}) => {
    ...
    return (
        <div>
            ...
            <p className='text-lg font-semibold'><span className='text-amber-700'>Condition: </span>{product.condition}</p>
            <p className='text-lg font-semibold'><span className='text-amber-700'>Seller: </span>{product.seller_name}</p>
            <p className='text-lg font-semibold'><span className='text-amber-700'>Seller Email: </span>{product.email}</p>
