                    ...
                    <label className="label">
                        ...
                        <div className="form-control">
                            <label className="label cursor-pointer">
                                ...
                                <input onChange={(e) => e.target.value} type="radio" value='admin' name="condition" className="radio checked:bg-red-500" defaultChecked />
                            </label>
                            </div>
                            <div className="form-control">
                            <label className="label cursor-pointer">
                                <span className="label-text text-xl">Seller</span> 
                                <input onChange={(e) => e.target.value} type="radio" value='seller' name="condition" className="radio checked:bg-blue-500" defaultChecked />
                            </label>
                        </div>
                            <div className="form-control">
                            <label className="label cursor-pointer">
